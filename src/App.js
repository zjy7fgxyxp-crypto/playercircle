...
const FLAG = {
  ...
  "Portugal":"🇵🇹","Qatar":"🇶🇦","Romania":"🇷🇴","Russia":"🇷🇺","Serbia":"🇷🇸",
  "Slovakia":"🇸🇰","South Africa":"🇿🇦","Spain":"🇪🇸","Sweden":"🇸🇪","Switzerland":"🇨🇭",
  "UAE":"🇦🇪","United Kingdom":"🇬🇧","USA":"🇺🇸","Ukraine":"🇺🇦","Uruguay":"🇺🇾",
  "Colombia":"🇨🇴","Peru":"🇵🇪","Ecuador":"🇪🇨","Kazakhstan":"🇰🇿","Finland":"🇫🇮",
  "United States":"🇺🇸","Great Britain":"🇬🇧","Chinese Taipei":"🇹🇼","South Korea":"🇰🇷",
};
const getFlag = (country) => FLAG[country] || "🌍";

// City tips DB (static)
const CITY_TIPS = {
  "Melbourne": [{cat:"Training",text:"Melbourne Park practice courts 6am–8pm. Book via Tennis Australia portal.",icon:"🎾"},{cat:"Recovery",text:"Stretch Lab South Yarra — best physio on circuit. Ask for Marcus.",icon:"💆"},{cat:"Food",text:"Tipo 00 CBD — carb loading done right. Incredible fresh pasta.",icon:"🍝"},{cat:"Hotel",text:"Crown Towers — 20% off during AO with your player credential.",icon:"🏨"},{cat:"Training Courts",text:"Melbourne Park has 22 practice courts. Courts 1-8 reserved for seeded players.",icon:"🎾"},{cat:"Physio",text:"Melbourne Sports Medicine Centre — open 7am. Best for emergency sessions.",icon:"🏥"},{cat:"Restaurant",text:"Cumulus Inc. — best breakfast in Melbourne. Book ahead or arrive at 7am.",icon:"🍳"},{cat:"Luxury Shopping",text:"Collins Street — Hermès, Louis Vuitton, Gucci all within 2 blocks.",icon:"🛍️"}],
  "Paris": [{cat:"Training",text:"Racing Club de France, Bois de Boulogne — clay courts 5 min from RG.",icon:"🎾"},{cat:"Recovery",text:"Institut du Sport 13ème — best cryotherapy in Paris.",icon:"💆"},{cat:"Food",text:"Café de Flore — breakfast only. The omelette is non-negotiable.",icon:"🥐"},{cat:"Hotel",text:"Molitor Hotel — rooftop pool, 10 min from Roland Garros by bike.",icon:"🏨"},{cat:"Training Courts",text:"Stade du Lendit — 8 clay courts, 20 min from RG. Less crowded than Racing Club.",icon:"🎾"},{cat:"Physio",text:"Centre Medical Raspail — 5 min from RG. Book day before.",icon:"🏥"},{cat:"Restaurant",text:"Le Relais de l Entrecote — no menu, just steak. Players love it after matches.",icon:"🥩"},{cat:"Luxury Shopping",text:"Avenue Montaigne — Dior, Chanel, Valentino. 15 min Uber from RG.",icon:"🛍️"}],
  "London": [{cat:"Training",text:"National Tennis Centre, Roehampton — book 2 weeks ahead in June.",icon:"🎾"},{cat:"Recovery",text:"Third Space Soho — best gym in central London, open 6am.",icon:"💆"},{cat:"Food",text:"Gymkhana — high protein Indian food, no dairy options available.",icon:"🍛"},{cat:"Hotel",text:"Cannizaro House, Wimbledon Village — walking distance to grounds.",icon:"🏨"},{cat:"Training Courts",text:"Aorangi Park practice courts — accessible for seeded players. Book through tournament office.",icon:"🎾"},{cat:"Physio",text:"Pure Sports Medicine Kensington — highly rated by players.",icon:"🏥"},{cat:"Restaurant",text:"The Fox and Grapes, Wimbledon Village — best Sunday roast post-match.",icon:"🍖"},{cat:"Luxury Shopping",text:"Harrods Knightsbridge — 20 min from Wimbledon by tube.",icon:"🛍️"}],
  "New York": [{cat:"Training",text:"USTA Billie Jean King Center — Courts 8-17 are always less crowded.",icon:"🎾"},{cat:"Recovery",text:"Equinox 61st — full recovery suite, cold plunge, sauna.",icon:"💆"},{cat:"Food",text:"Carbone — book 3 weeks ahead minimum. Worth every dollar.",icon:"🍷"},{cat:"Hotel",text:"1 Hotel Brooklyn Bridge — great views, 25 min Uber to Flushing.",icon:"🏨"},{cat:"Training Courts",text:"Sportime Randall s Island — indoor hard courts, best option during rain.",icon:"🎾"},{cat:"Physio",text:"Hospital for Special Surgery — world class sports medicine, 10 min from Midtown.",icon:"🏥"},{cat:"Restaurant",text:"Le Bernardin — best for light pre-match dinner. Excellent fish.",icon:"🐟"},{cat:"Luxury Shopping",text:"5th Avenue — Saks, Bergdorf Goodman. Players spotted here every year.",icon:"🛍️"}],
  "Miami": [{cat:"Training",text:"Crandon Park — courts next to the venue. Go before 9am.",icon:"🎾"},{cat:"Recovery",text:"Next Health Brickell — ice barrels essential in Miami heat.",icon:"💆"},{cat:"Food",text:"Zuma Brickell — light Japanese, clean proteins. Players go here every year.",icon:"🍱"},{cat:"Hotel",text:"EAST Miami — rooftop pool, 15 min Uber to Key Biscayne.",icon:"🏨"},{cat:"Training Courts",text:"Brickell Tennis Center — 6 hard courts, air-conditioned facility nearby.",icon:"🎾"},{cat:"Physio",text:"Baptist Health Sports Medicine — official tournament physio partner.",icon:"🏥"},{cat:"Restaurant",text:"Komodo Brickell — best post-match dinner spot. Reserve 2 weeks ahead.",icon:"🍽️"},{cat:"Luxury Shopping",text:"Bal Harbour Shops — Chanel, Prada, Loro Piana. 30 min north.",icon:"🛍️"}],
  "Dubai": [{cat:"Training",text:"Dubai Tennis Stadium courts available from 7am during tournament week.",icon:"🎾"},{cat:"Recovery",text:"Talise Ottoman Spa at Jumeirah Zabeel Saray — best recovery spa in the city.",icon:"💆"},{cat:"Food",text:"Zuma DIFC — same quality as Miami. Essential stop during Dubai swing.",icon:"🍱"},{cat:"Hotel",text:"One&Only Royal Mirage — quiet, 15 min from venue. Players favorite.",icon:"🏨"},{cat:"Training Courts",text:"Aviation Club — original tournament venue, courts available for practice.",icon:"🎾"},{cat:"Physio",text:"Physiotheray World DIFC — recommended by multiple top 50 players.",icon:"🏥"},{cat:"Restaurant",text:"Nobu at Atlantis — iconic, worth the trip to Palm Jumeirah.",icon:"🍣"},{cat:"Luxury Shopping",text:"Dubai Mall — Louis Vuitton, Rolex, all major brands. Adjacent to Burj Khalifa.",icon:"🛍️"}],
  "Madrid": [{cat:"Training",text:"Caja Magica practice courts — 12 courts available. Book through tournament.",icon:"🎾"},{cat:"Recovery",text:"Clinica CEMTRO — best sports medicine in Madrid, used by Real Madrid players.",icon:"💆"},{cat:"Food",text:"DiverXO — Michelin 3-star by David Munoz. Book 2 months ahead.",icon:"⭐"},{cat:"Hotel",text:"Rosewood Villa Magna — central, 20 min to Caja Magica.",icon:"🏨"},{cat:"Luxury Shopping",text:"Calle Serrano — Spanish luxury row. Loewe flagship, Balenciaga, Prada.",icon:"🛍️"}],
  "Rome": [{cat:"Training",text:"Foro Italico practice courts — clay courts, book through tournament office.",icon:"🎾"},{cat:"Recovery",text:"Villa Stuart Sports Clinic — used by AS Roma, excellent physio team.",icon:"💆"},{cat:"Food",text:"Da Enzo al 29, Trastevere — authentic Roman, cacio e pepe is perfect.",icon:"🍝"},{cat:"Hotel",text:"Hotel Eden — rooftop restaurant, views of Villa Borghese.",icon:"🏨"},{cat:"Luxury Shopping",text:"Via Condotti — Gucci, Bulgari, Valentino. 5 min from Spanish Steps.",icon:"🛍️"}],
  "Monte Carlo": [{cat:"Training",text:"Monte-Carlo Country Club courts — request practice courts through tournament.",icon:"🎾"},{cat:"Recovery",text:"Thermes Marins Monte-Carlo — thalassotherapy, sea water pools.",icon:"💆"},{cat:"Food",text:"Le Louis XV by Alain Ducasse — best restaurant in Monaco. Reserve ahead.",icon:"⭐"},{cat:"Hotel",text:"Hotel de Paris — legendary. Connected to Casino. Players stay here.",icon:"🏨"},{cat:"Luxury Shopping",text:"Casino Square — Hermes, Cartier, Dior. 2 min walk from the casino.",icon:"🛍️"}],
  "Indian Wells": [{cat:"Training",text:"Indian Wells Tennis Garden — 26 courts, one of the best facilities on tour.",icon:"🎾"},{cat:"Recovery",text:"Eisenhower Health — full sports medicine team on site during tournament.",icon:"💆"},{cat:"Food",text:"Las Casuelas Terraza — best Mexican in the desert, players staple.",icon:"🌮"},{cat:"Hotel",text:"The Ritz-Carlton Rancho Mirage — stunning desert views, 15 min to venue.",icon:"🏨"},{cat:"Luxury Shopping",text:"El Paseo Drive — the Rodeo Drive of the desert. Gucci, Tory Burch, Lululemon.",icon:"🛍️"}],
  "Shanghai": [{cat:"Training",text:"Qi Zhong practice courts — request through tournament. 15 hard courts.",icon:"🎾"},{cat:"Recovery",text:"Shanghai United Family Hospital Sports Medicine — best in the city.",icon:"💆"},{cat:"Food",text:"Ultraviolet by Paul Pairet — 20-course immersive experience. Book months ahead.",icon:"⭐"},{cat:"Hotel",text:"The Peninsula Shanghai — Bund views, butler service, player favorite.",icon:"🏨"},{cat:"Luxury Shopping",text:"Plaza 66 Nanjing Road — Chanel, Hermes, Louis Vuitton.",icon:"🛍️"}],
  "Tokyo": [{cat:"Training",text:"Ariake Colosseum courts — tournament practice facility, book early.",icon:"🎾"},{cat:"Recovery",text:"Roppongi Hills Club Spa — excellent hydrotherapy and massage.",icon:"💆"},{cat:"Food",text:"Sukiyabashi Jiro Honten — if you can get a reservation, go. Simple, perfect.",icon:"🍣"},{cat:"Hotel",text:"Aman Tokyo — best hotel in Japan. Serene, perfect for recovery.",icon:"🏨"},{cat:"Luxury Shopping",text:"Ginza — Uniqlo flagship, Dover Street Market, all luxury brands.",icon:"🛍️"}],
  "Vienna": [{cat:"Training",text:"Wiener Stadthalle courts — indoor hard courts, available during tournament week.",icon:"🎾"},{cat:"Recovery",text:"Therme Wien — thermal spa, one of the best in Europe.",icon:"💆"},{cat:"Food",text:"Steirereck im Stadtpark — two Michelin stars, best in Vienna.",icon:"⭐"},{cat:"Hotel",text:"Hotel Sacher — historic, central, famous Sachertorte.",icon:"🏨"},{cat:"Luxury Shopping",text:"Kohlmarkt — Cartier, Chanel, Louis Vuitton. Vienna luxury street.",icon:"🛍️"}],
  "Basel": [{cat:"Training",text:"St. Jakobshalle courts — practice available before 10am during tournament.",icon:"🎾"},{cat:"Recovery",text:"Thermalbad and Spa Zurich — 45 min away, worth the trip for a rest day.",icon:"💆"},{cat:"Food",text:"Restaurant Stucki — one Michelin star, Swiss-French. 15 min from venue.",icon:"⭐"},{cat:"Hotel",text:"Les Trois Rois — Rhein views, old town location, elegant.",icon:"🏨"},{cat:"Luxury Shopping",text:"Freie Strasse — Bucherer watches, Bally, local Swiss designers.",icon:"🛍️"}],
  "Rotterdam": [{cat:"Training",text:"Rotterdam Ahoy courts — available early morning. Speak to tournament desk.",icon:"🎾"},{cat:"Recovery",text:"Erasmus MC Sports Medicine — best in the Netherlands.",icon:"💆"},{cat:"Food",text:"Restaurant Fred — creative Dutch cuisine, small menu, excellent quality.",icon:"🍽️"},{cat:"Hotel",text:"nhow Rotterdam — design hotel in the Cube Houses area.",icon:"🏨"},{cat:"Luxury Shopping",text:"Beurstraverse — Bijenkorf, Hugo Boss, Tommy Hilfiger.",icon:"🛍️"}],
};
...
const CSS = `
  ...
  *, *::before, *::after { margin:0; padding:0; box-sizing:border-box; }
  ...
  .hp { animation:heartPop 0.3s ease; }
`;

const Avatar = ({ name, size=38, glow=false }) => (
  <div style={{ width:size, height:size, borderRadius:"50%", background:"linear-gradient(135deg,var(--green) 0%,#00b3d4 100%)", display:"flex", alignItems:"center", justifyContent:"center", fontSize:size*0.38, fontWeight:700, color:"#000", flexShrink:0, boxShadow:glow?"0 0 20px rgba(0,208,132,0.4)":"none" }}>
    {(name||"?")[0].toUpperCase()}
  </div>
);
...
const Badge = ({ children, color, bg }) => (
  <div style={{ fontSize:9, fontWeight:700, letterSpacing:"0.1em", textTransform:"uppercase", padding:"3px 9px", borderRadius:999, color:color||"var(--green)", background:bg||"rgba(0,208,132,0.12)", border:`1px solid ${color||"var(--green)"}22`, display:"inline-flex", alignItems:"center" }}>{children}</div>
);
...
export default function App() {
  ...
  const [checkins, setCheckins] = useState([]); // player_ids checked in to selected tournament
  ...
  // Load map when tournament selected
  useEffect(() => {
    if (selectedTournament && showMap && mapRef.current) {
      initMap(selectedTournament.lat, selectedTournament.lng, selectedTournament.tournament_name);
    }
  }, [selectedTournament, showMap]);

  const initMap = (lat, lng, name) => {
    if (!mapRef.current) return;
    const iframe = mapRef.current;
    iframe.src = `https://maps.google.com/maps?q=${lat},${lng}&z=14&output=embed&hl=en`;
  };
  ...
  const loadTournaments = async () => {
    const { data } = await supabase.from("tournaments").select("*").order("category");
  ...
  const loadTournamentPlayers = async (tournamentId) => {
    ...
    if (data) setCityPlayers(data.map(d => d.players).filter(Boolean));
    // Check if current player is checked in
    if (player) {
      const mine = data?.find(d => d.player_id === player.id);
      setCheckedIn(!!mine);
    }
  };
  ...
  const findNearestCity = (lat, lng) => {
    ...
    // Only auto-detect if within ~500km
    if (nearest && minDist < 5) setDetectedCity(nearest.city);
  };
  ...
  const submitPost = async () => {
    ...
    const { data } = await supabase.from("posts").insert([{ author:player.name, country:player.country, ranking:player.ranking, content:postText, category:postCat, likes:0, replies:0, user_id:player.user_id, media_url, media_type:mtype }]).select().single();
  ...
  const toggleLike = async (post) => {
    ...
    setLikedAnim(l => ({ ...l, [post.id]:true }));
    setTimeout(() => setLikedAnim(l => ({ ...l, [post.id]:false })), 300);
  ...
  const tournamentsByCity = tournaments.reduce((acc, t) => {
      ...
      <div style={{ width:"100%", maxWidth:420 }} className="fu">
        ...
        <div style={{ marginBottom:16 }}>
          ...
          <div style={{ display:"flex", gap:8 }}>
            {TOURS.map(t => <button key={t} onClick={() => setRf({ ...rf, tour:t })} style={{ flex:1, padding:"10px", border:`1px solid ${rf.tour===t?"var(--green)":"var(--border)"}`, background:rf.tour===t?"rgba(0,208,132,0.1)":"transparent", color:rf.tour===t?"var(--green)":"var(--text2)", borderRadius:10, fontSize:13, fontWeight:rf.tour===t?700:400 }}>{t}</button>)}
          </div>
        </div>
        <div style={{ marginBottom:16 }}>
  ...
  const BottomNav = () => (
    <div style={{ position:"fixed", bottom:0, left:0, right:0, background:"rgba(10,10,11,0.94)", backdropFilter:"blur(20px)", borderTop:"1px solid var(--border)", display:"flex", zIndex:50, maxWidth:480, margin:"0 auto", paddingBottom:"env(safe-area-inset-bottom,0px)" }}>
      {navItems.map(item => (
        <button key={item.id} onClick={() => { setTab(item.id); if (item.id==="admin") loadPending(); if (item.id==="cities" && !tournaments.length) loadTournaments(); }} style={{ flex:1, display:"flex", flexDirection:"column", alignItems:"center", gap:4, padding:"12px 8px 14px", background:"transparent" }}>
    ...
    <div style={{ paddingBottom:120 }}>
        ...
        {(composeFocused||postText||mediaPreview) && (
          <div style={{ padding:"10px 16px 14px", borderTop:"1px solid var(--border2)", display:"flex", alignItems:"center", justifyContent:"space-between", gap:10 }}>
            <div style={{ display:"flex", gap:8, alignItems:"center" }}>
              ...
              <select value={postCat} onChange={e => setPostCat(e.target.value)} style={{ background:"var(--bg2)", border:"1px solid var(--border)", color:CAT_COLOR[postCat]||"var(--text2)", borderRadius:8, padding:"5px 10px", fontFamily:"inherit", fontSize:11, fontWeight:600 }}>
      ...
      {filteredPosts.map((post, i) => (
        <div key={post.id} className="post" style={{ margin:"0 16px 10px", background:"var(--bg1)", border:"1px solid var(--border)", borderRadius:16, overflow:"hidden", animationDelay:`${i*0.03}s` }}>
          ...
          <div style={{ display:"flex", alignItems:"center", gap:2, padding:"8px 12px", borderTop:"1px solid var(--border2)" }}>
            <button onClick={() => toggleLike(post)} className={likedAnim[post.id]?"hp":""} style={{ display:"flex", alignItems:"center", gap:6, background:"transparent", color:myLikes.has(post.id)?"#ef4444":"var(--text3)", fontSize:13, padding:"6px 12px", borderRadius:10, fontWeight:myLikes.has(post.id)?600:400 }}>
              {myLikes.has(post.id)?"❤️":"🤍"} {post.likes||0}
            </button>
            <button onClick={() => toggleCms(post.id)} style={{ display:"flex", alignItems:"center", gap:6, background:"transparent", color:expandedCms[post.id]?"var(--green)":"var(--text3)", fontSize:13, padding:"6px 12px", borderRadius:10 }}>
              💬 {post.replies||0}
            </button>
          </div>
          {expandedCms[post.id] && (
  ...
  const CitiesTab = () => {
    ...
    const tipCategories = [...new Set(tips.map(t => t.cat))];
    const visibleTips = tips.filter(t => t.cat === activeTip);
    const cityTournaments = selectedTournament ? tournamentsByCity[selectedTournament.city] || [] : [];
    const sortedTournaments = [...cityTournaments].sort((a,b) => (CAT_RANK[a.category]||9) - (CAT_RANK[b.category]||9));
    ...
    if (selectedTournament) return (
      <div style={{ paddingBottom:120 }}>
        ...
        <div style={{ padding:"14px 16px", display:"flex", alignItems:"center", gap:12, borderBottom:"1px solid var(--border2)" }}>
          ...
          <div style={{ flex:1 }}>
            <div style={{ fontSize:16, fontWeight:700 }}>{selectedTournament.tournament_name}</div>
            <div style={{ fontSize:11, color:"var(--text3)" }}>{selectedTournament.city}, {selectedTournament.country}</div>
          </div>
          <Badge color={SURFACE_COLOR[selectedTournament.surface]} bg={`${SURFACE_COLOR[selectedTournament.surface]}18`}>{selectedTournament.surface}</Badge>
        </div>

        {/* Tournament info bar */}
        <div style={{ display:"flex", gap:10, padding:"14px 16px", overflowX:"auto", borderBottom:"1px solid var(--border2)" }}>
          {[
            { label:"Category", value:selectedTournament.category },
            { label:"Prize", value:selectedTournament.prize_money },
            { label:"Month", value:["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"][selectedTournament.month-1] },
            { label:"Tour", value:selectedTournament.tour },
          ].map(({ label, value }) => (
            <div key={label} style={{ flexShrink:0, background:"var(--bg1)", border:"1px solid var(--border)", borderRadius:10, padding:"10px 14px", textAlign:"center" }}>
              <div style={{ fontSize:13, fontWeight:700, color:"var(--text)", whiteSpace:"nowrap" }}>{value}</div>
              <div style={{ fontSize:9, color:"var(--text3)", textTransform:"uppercase", letterSpacing:"0.08em", marginTop:2 }}>{label}</div>
            </div>
          ))}
        </div>
              ...
              <div style={{ display:"flex", gap:8, overflowX:"auto" }}>
                {cityPlayers.map((p, i) => (
                  <div key={i} style={{ flexShrink:0, display:"flex", flexDirection:"column", alignItems:"center", gap:4 }}>
                    <div style={{ width:40, height:40, borderRadius:"50%", background:"linear-gradient(135deg,var(--green) 0%,#00b3d4 100%)", display:"flex", alignItems:"center", justifyContent:"center", fontSize:14, fontWeight:700, color:"#000", border:"2px solid var(--bg1)", position:"relative" }}>
                      {(p.name||"?")[0].toUpperCase()}
                      <span style={{ position:"absolute", bottom:-2, right:-2, fontSize:12 }}>{getFlag(p.country)}</span>
                    </div>
        ...
        {/* Other tournaments in this city */}
        {sortedTournaments.length > 1 && (
          <div style={{ padding:"14px 16px", borderBottom:"1px solid var(--border2)" }}>
            ...
            <div style={{ display:"flex", gap:8, overflowX:"auto" }}>
              {sortedTournaments.filter(t => t.id !== selectedTournament.id).map(t => (
        ...
        <div style={{ padding:"14px 16px", borderBottom:"1px solid var(--border2)" }}>
          <button onClick={() => setShowMap(!showMap)} style={{ width:"100%", background:"var(--bg1)", border:"1px solid var(--border)", color:"var(--text)", borderRadius:12, padding:"12px", fontSize:13, fontWeight:500, display:"flex", alignItems:"center", justifyContent:"center", gap:8 }}>
            🗺️ {showMap ? "Hide map" : `Show map · ${selectedTournament.venue}`}
          </button>
          {showMap && (
            <div style={{ marginTop:12, borderRadius:12, overflow:"hidden", border:"1px solid var(--border)", height:220 }}>
              <iframe
                ref={mapRef}
      ...
      <div style={{ paddingBottom:120 }}>
        ...
        <div style={{ padding:"14px 16px", borderBottom:"1px solid var(--border2)" }}>
          {detectedCity ? (
            ...
            <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between" }}>
              <span style={{ fontSize:13, color:"var(--text2)" }}>
                {locationLoading ? "Detecting location..." : "Where are you?"}
              </span>
              <div style={{ display:"flex", gap:8 }}>
          ...
          {showCitySearch && (
            <div style={{ marginTop:10 }}>
              <input style={{ width:"100%", background:"var(--bg2)", border:"1px solid var(--border)", borderRadius:10, padding:"10px 14px", color:"var(--text)", fontSize:13 }} placeholder="Search city or tournament..." value={citySearch} onChange={e => setCitySearch(e.target.value)} autoFocus />
            </div>
          )}
        </div>
            ...
            <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:8, marginBottom:20 }}>
              {tournaments.filter(t => t.category==="Grand Slam").map(t => (
                <button key={t.id} onClick={() => selectTournament(t)} style={{ background:"var(--bg1)", border:"1px solid var(--border)", borderRadius:14, padding:"16px", textAlign:"left", position:"relative", overflow:"hidden" }}>
                  ...
                  <div style={{ fontSize:22, marginBottom:6 }}>{getFlag(t.country)}</div>
                  ...
                  <Badge color={SURFACE_COLOR[t.surface]} bg={`${SURFACE_COLOR[t.surface]}15`}>{t.surface}</Badge>
                </button>
              ))}
            </div>
          </div>
        ...
        <div style={{ padding:"0 16px" }}>
          ...
          {filteredCities.map((cityName, i) => {
            const cityTs = tournamentsByCity[cityName] || [];
            const top = cityTs.sort((a,b) => (CAT_RANK[a.category]||9)-(CAT_RANK[b.category]||9))[0];
            if (!top) return null;
            ...
            return (
              <button key={cityName} onClick={() => selectTournament(top)} className="fu" style={{ width:"100%", background:isNear?"rgba(0,208,132,0.05)":"var(--bg1)", border:`1px solid ${isNear?"rgba(0,208,132,0.2)":"var(--border)"}`, borderRadius:14, padding:"14px 16px", display:"flex", alignItems:"center", gap:12, marginBottom:8, textAlign:"left", animationDelay:`${i*0.02}s` }}>
                ...
                <div style={{ flex:1 }}>
                  ...
                  <div style={{ fontSize:11, color:"var(--text3)" }}>{cityTs.length} tournament{cityTs.length>1?"s":""} · {top.country}</div>
                </div>
                <div style={{ display:"flex", flexDirection:"column", gap:3, alignItems:"flex-end" }}>
                  <Badge color={SURFACE_COLOR[top.surface]} bg={`${SURFACE_COLOR[top.surface]}15`}>{top.surface}</Badge>
      ...
      <div style={{ background:"var(--bg1)", border:"1px solid var(--border)", borderRadius:20, padding:24, marginBottom:12, position:"relative", overflow:"hidden" }}>
        ...
        <div style={{ display:"flex", alignItems:"center", gap:16, marginBottom:20 }}>
          <div style={{ position:"relative" }}>
            ...
            <span style={{ position:"absolute", bottom:-4, right:-4, fontSize:22 }}>{getFlag(player?.country)}</span>
          </div>
          <div>
            ...
            <div style={{ fontSize:11, color:"var(--green)", marginTop:4, display:"flex", alignItems:"center", gap:5 }}>
              <span style={{ width:6, height:6, borderRadius:"50%", background:"var(--green)", display:"inline-block" }} />Verified · Rank #{player?.ranking}
            </div>
          </div>
        </div>
